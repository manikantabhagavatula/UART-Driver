...
int memory_init(void)
{
  ...
  /* Registering device */
  result = register_chrdev(memory_major, "uart-driver", &memory_fops);
  if (result < 0) {
 ...
 /* Allocating memory for the buffer */
  ...
  printk(KERN_ERR "Inserting UART module\n"); 
  return 0;
...
void memory_exit(void) 
{
  ...
  unregister_chrdev(memory_major, "uart-driver");
